...
let AuthController = class AuthController {
    ...
    async register(dto, ip, req) {
        const result = await this.authService.register(dto, ip, userAgent(req));
        await this.audit.log(client_1.AuditAction.REGISTER, { userId: result.user.id, entity: 'User', entityId: result.user.id, ip });
        return result;
    }
    async login(dto, ip, req) {
        const result = await this.authService.login(dto, ip, userAgent(req));
        await this.audit.log(client_1.AuditAction.LOGIN, { userId: result.user.id, entity: 'User', entityId: result.user.id, ip });
        return result;
    }
    ...
    async logoutAll(user, ip) {
        await this.audit.log(client_1.AuditAction.LOGOUT, { userId: user.id, entity: 'Session', ip });
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Login (JWT + Refresh Token)' }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Ip)()),
    __param(2, (0, common_1.Req)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Rotacionar refresh token e obter novo access token' }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Ip)()),
    __param(2, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [refresh_dto_1.RefreshDto, String, Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Revogar sessão' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Encerrar todas as sessões (revoga refresh tokens)' }),
