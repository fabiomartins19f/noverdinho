...
let UsersController = class UsersController {
    usersService;
    audit;
    constructor(usersService, audit) {
    ...
    async deleteAccount(user, req) {
        await this.audit.log(client_1.AuditAction.DELETE, {
            userId: user.id,
            entity: 'User',
            entityId: user.id,
            ip: req.ip,
...
__decorate([
    (0, common_1.Get)('me'),
    (0, swagger_1.ApiOperation)({ summary: 'Dados do usuário autenticado + resumo financeiro' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Excluir conta (LGPD) — apaga dados pessoais' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
